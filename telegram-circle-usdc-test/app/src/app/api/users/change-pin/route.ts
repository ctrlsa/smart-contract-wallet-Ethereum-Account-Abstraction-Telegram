/**
 * @api {get} /users/change-pin Change Pin
 * @apiName ChangePin
 * @apiGroup Users
 * @apiDescription This API route is responsible for changing the user pin.
 */
...
export async function GET(req: NextRequest) {
  try {
    ...
    // get the challenge id from the circle server to update the user pin
